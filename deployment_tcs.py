...
model=tensorflow.keras.models.load_model(r"C:\Users\vacha\Downloads\tcs_model2 (1).h5")
...
df=pd.read_csv("C:\Users\vacha\TCS.NS.csv")
st.dataframe(df)
...
df_=pd.read_csv("C:\Users\vacha\TCS.NS.csv")
df_=df_["Close"] 
